...
public class DataStreamProcessingGUI extends JFrame {
    ...
    private void createUI() {
        ...
        // Use a panel with BorderLayout for the control components
        ...
        // Put the quit button at the south of the control panel
        JPanel quitPanel = new JPanel(new FlowLayout(FlowLayout.RIGHT));
        quitPanel.add(quitButton);

        // Combine control panel and quit button panel
